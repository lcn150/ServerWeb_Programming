...
body{
    border: 0;
    padding: 0; 
    background-image: url('../movie36.jpg');
...
?>
  <h1 style="color:cyan"><?php echo $catagory; ?>에서 '<?php echo $search_con; ?>'검색결과</h1>
  <h4 style="margin-top:30px;"><a href="index1.php">홈으로</a></h4>
    <table class="list-table">
      <thead>
          <tr>
              <th style="color:green"width="70">번호</th>
                <th style="color:pink" width="500">제목</th>
                <th style="color:yellow"width="120">글쓴이</th>
                <th style="color:purple"width="100">작성일</th>
                <th style="color:red"width="100">조회수</th>
            </tr>
        </thead>
        <?php
